...
output=Path('/Users/kisung/Desktop/develop/geojax/audit/2026-09-25/validation/frechet_default_stress/frechet_default_stress.json')
...
for index,(name,scale,M,a,b,kind) in enumerate(cases,1):
 ...
 try:
  ...
  fit=frechet_mean(M,data,sample_weight=weights)
 ...
 summary={'jax':jax.__version__,'x64':jax.config.jax_enable_x64,'solver':'default frechet_mean','planned_cases':len(cases),'completed_cases':len(records),'seconds':time.monotonic()-started,'cases':records}
