...
for name,M,array,reference in cases:
 ...
 Path('/Users/kisung/Desktop/develop/geojax/audit/2026-09-25/validation/frechet_default_stress/frechet_default_noncollinear.json').write_text(json.dumps({'jax':jax.__version__,'x64':jax.config.jax_enable_x64,'cases':records},indent=2)+'\n')
